...
> Method 2: Make a pivot longer form from all keywords and cross tabulate for all Titles and Keywords.
...
> Data preprocessing. We remove things like special symbols (&, <, >), URLs, emojis, stopwords, stopwords without apostrophe (eg dont), usernames
