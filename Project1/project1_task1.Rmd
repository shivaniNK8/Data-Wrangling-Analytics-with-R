...
```{r}
#3d plotting according to actual class
fig <- plot_ly(data2, x = ~X1, y = ~X2, z = ~X3, color = ~Class)
fig <- fig %>% add_markers()
fig <- fig %>% layout(scene = list(xaxis = list(title = 'X1'),
                     yaxis = list(title = 'X2'),
                     zaxis = list(title = 'X3')))
fig
#3d plotting according to Kmeans cluster
fig <- plot_ly(data2, x = ~X1, y = ~X2, z = ~X3, color = ~kmeans_cluster)
fig <- fig %>% add_markers()
fig <- fig %>% layout(scene = list(xaxis = list(title = 'X1'),
                     yaxis = list(title = 'X2'),
                     zaxis = list(title = 'X3')))
fig
#3d plotting according to hierarchical cluster
fig <- plot_ly(data2, x = ~X1, y = ~X2, z = ~X3, color = ~h_cluster)
fig <- fig %>% add_markers()
fig <- fig %>% layout(scene = list(xaxis = list(title = 'X1'),
                     yaxis = list(title = 'X2'),
                     zaxis = list(title = 'X3')))
...
```{r}
#plot data by class
scatterplot3d(data2$X1,data2$X2,data2$X3,main="Data1",xlab="X1",ylab="X2",zlab="X3",pch=16,color = as.numeric(data2$Class))
#plot by clustering algorithm of K-means
scatterplot3d(data2$X1,data2$X2,data2$X3,main="Data1",xlab="X1",ylab="X2",zlab="X3",pch=16,color = as.numeric(data2$kmeans_cluster))
#plot by clustering algorithm of hierarchical
scatterplot3d(data2$X1,data2$X2,data2$X3,main="Data1",xlab="X1",ylab="X2",zlab="X3",pch=16,color = as.numeric(data2$h_cluster))  
```
